        ...
        <div class="col-md-6 col-lg-4">
            <div class="widget widget-default widget-fluctuation">
                <header class="widget-header">
                    <a href="/view/campaign/{{$campaign->campaign_id}}" style="overflow:hidden;">{{$campaign->campaign_name }}</a>
                        ...
                        <div style="list-style: none;">
                            <li>
                                <div style="overflow: hidden; height: 1.5em;">
                                    Artist: &nbsp;{{$campaign->first_name}} &nbsp;{{$campaign->last_name}}
                                </div>
                            </li>
                            <li style="height: 50px;margin-bottom: 19px;">
                                @php
                            ...
                            <li>BPM: &nbsp;{{$campaign->bpm}}</li>
                            <br/>
                            <li onclick="reaction({{$campaign->id}}, 1)" ><i class="fa fa-thumbs-o-up" aria-hidden="true" data-toggle="tooltip" title="Click to like"></i> {{$campaign->likes}}</li>
                            <li onclick="reaction({{$campaign->id}}, 0)" ><i class="fa fa-thumbs-o-down" aria-hidden="true" data-toggle="tooltip" title="Click to dislike"></i> {{$campaign->dislikes}}</li>
                        </div>
                    </section>
                </div>
                <header class="widget-header">
