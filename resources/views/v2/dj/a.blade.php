            ...
            <div class="log-in-wrapper">
                ...
                <form method="POST" action="{{ route('newlogin') }}" id="form">
                    ...
                    <div class="form-group has-success">
                        <div class="{{ $errors->has('invitationcode') ? ' has-error' : '' }}">
                            <input type="text" class="form-control" name="invitationcode"  data-validetta="required,minLength[7]" value="{{$code }}">
                            <p class="help-block"><span class="fa fa-lock list-group-item-icon"></span> Please enter your DJ Invite Code.</p>
                    ...
                    <div class="form-group {{ $errors->has('firstname') ? ' has-error' : '' }}">
                        <input class="form-control input-lg" id="fname" placeholder="First Name" name="firstname" value="{{ old('firstname') }}" data-validetta="required,text">
                    ...
                    <div class="form-group {{ $errors->has('lastname') ? ' has-error' : '' }}">
                        <input class="form-control input-lg" id="lname" placeholder="Last Name" name="lastname" value="{{ old('lastname') }}" data-validetta="required,text">
                    ...
                    <div><small>Choose DJ Type</small>
                    </div>
                    <div class="form-group select_group " role="group">
                    ...
                    <div class="form-group select_group {{ $errors->has('city') ? ' has-error' : '' }}">
