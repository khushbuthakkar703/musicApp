	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 col-lg-9">
				<h1 class="page-header-heading"><span class="typcn typcn-th-small page-header-heading-icon"></span> Artist Managers</h1>

			</div>
			<div class="col-xs-12 col-lg-3">
				<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Add New Manager</button>
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td>{{$campaign->song_title}}</td>
							<td>${{$campaign->campaign_balance}}</td>
	  	...
	  	<div class="modal-dialog">
	  	  ...
	  	  <div class="modal-content">
	  	    <div class="modal-header">
	  	      ...
	  	      <h4 class="modal-title">Add new artist manager</h4>
	  	    </div>
	  	    <form method="POST" action="{{route('admin.artistmanager.add')}}">
