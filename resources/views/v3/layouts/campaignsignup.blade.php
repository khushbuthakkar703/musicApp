...
<head>
    ...
    <title>Sign Up | Spinstatz</title>
</head>

<body class="text-white">
<div class="col-md-12 d-flex justify-content-between text-center">
    ...
    <div class="col-md-4 login-div">
        <img src="/img/shape.jpg" class="login-div-img" />
        <h4 class="login-div-text">
...
<div class="col-md-12">
    <div class="row">
        ...
        >
            <h1 class="font-weight-bold">Create your Artist Campaign</h1>
            <h5 class="px-5 font-weight-light">
                Create a campaign for your songs by filling out the fields below.
            </h5>
        </div>
    </div>
    ...
    <div class="row mt-5 pb-5">
        ...
        <div class="col-md-8 offset-md-2">
            <form class="dj-form" method="POST" action="{{route('campaign.signup')}}">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="" placeholder="Address" name="address"  value="{{old('address')}}"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <input type="text"  placeholder="Zip/Postal code" name="zipcode"  value="{{old('zipcode')}}"/>
                    </div>
                </div>
