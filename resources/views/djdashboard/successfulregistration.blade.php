...
<head>
    ...
    <title>SpinStatz Manager Registration</title>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
  <!-- Bootstrap and Font Awesome css-->
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="/countdown/favicon.png">
...
<body >
    ...
    <section class="sidebar-user-panel"><!-- <button class="user-panel-toggler" data-slide-toggle="user-panel-slide-toggleable"><span class="fa fa-chevron-up" data-slide-toggle-showing></span><span class="fa fa-chevron-down" data-slide-toggle-hidden></span></button> -->

    Registration Complete</section>

    <ul class="sidebar-nav">
      <li class="sidebar-nav-heading">Step 2</li>
 <div class="col-xs-12">
 ...
 <table width="90%" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
      <td align="center"><img src="/img/Spinstatz_Icon.png" width="100" height="107" alt=""/></td>
    </tr>
  </tbody>
</table>
          ...
          <ul class="sidebar-nav">
              ...
              <li class="sidebar-nav-link">
                    ...
                    <li class="sidebar-nav-link ">
                        ...
                        <a href="/app-pages/inbox/view.html">
                    ...
                    <li class="sidebar-nav-link ">
                        ...
                        <a href="/app-pages/profile/update.html">
                    ...
                    <li class="sidebar-nav-link ">
                        ...
                        <a href="/app-pages/calendar.html">
                    ...
                    <li class="sidebar-nav-link ">
                        ...
                        <a href="/app-pages/page-not-found.html">
        ...
        <li class="sidebar-nav-link  active "></li>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
              ...
              <h1 class="page-header-heading"><span class="typcn typcn-clipboard page-header-heading-icon"></span> Registration Form Submitted</h1>

                <p class="page-header-description">Congratulations you have successfully completed and submitted your coalition registration form. Our staff will now begin the process of verifying your organization. Someone from our company will be in contact with you shortly to get things rolling. Once your company has been verified you will receive an email notification informing you that your company has been approved.</p>
                <p class="page-header-description">&nbsp;</p>
                <p class="page-header-description">Kind Regards,</p>
                <p class="page-header-description">&nbsp;</p>
                <p class="page-header-description"><em>SpinStatz staff</em><br></p>
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
      <td align="center"><span class="fa-5x">Official Launch</span>
        ...
        <div id="countdown" class="countdown">
          <div class="row">
            <div class="countdown-item col-sm-3 col-xs-6">
              <div class="countdown-number" id="countdown-days" style="font-size: 90px;">&nbsp;</div>
              <div class="countdown-label">days</div>
            </div>
            <div class="countdown-item col-sm-3 col-xs-6">
              <div class="countdown-number" id="countdown-hours" style="font-size: 90px">&nbsp;</div>
              <div class="countdown-label">hours</div>
            </div>
            <div class="countdown-item col-sm-3 col-xs-6">
              <div class="countdown-number" id="countdown-minutes" style="font-size: 90px">&nbsp;</div>
              <div class="countdown-label">minutes</div>
            </div>
            <div class="countdown-item col-sm-3 col-xs-6">
              <div class="countdown-number" id="countdown-seconds" style="font-size: 90px">&nbsp;</div>
...
<footer class="content-wrapper-footer">
     ...
     &copy; Copyright 2017 SpinStatz <a href="#" target="_blank">OttoMation Solutions LLC&nbsp;&nbsp;  </a>
